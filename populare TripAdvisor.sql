...
INSERT INTO CategoriiObiective( CategorieID, Denumire)
VALUES    (1, 'Architectural Buildigs'),
          (2, 'City Tours'),
		  (3, 'Things To Do'),
		  (4, 'Fun & Games'),
		  (5, 'Food Tours'),
...
INSERT INTO Obiective(ObiectivID, Denumire, Locatie, OrasID, CategorieID)
VALUES  (21, 'Communism Tour of Bucharest', 'Bucharest', 11, 2),
        (22, 'Half Day Tour in Bucharest', 'Bucharest', 11, 2),
		(23, 'Darkside Tour of Bucharest', 'Bucharest', 11, 2),
		(141, 'Transylvania and Dracula s Castle Full Day Tour ', 'Transylvania', 11, 14),
		(142, 'Three Castles in Transylvania Private Day Trip from Bucharest', 'Transylvania', 11, 14),
		(131, 'Plaza Mall', 'Bucharest',11, 8),
		(132, 'Promanada Mall','Bucharest', 11, 8)
